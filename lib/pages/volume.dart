...
class _VolumeConverterPageState extends State<VolumeConverterPage> {
  ...
  final List<String> _volumeUnits = const [
    'Cubic Millimeters',
    'Cubic Centimeters',
    'Milliliters',
    'Cubic Meters',
  ...
  static const Map<String, double> _cubicMetersPerUnit = {
    ...
    'US Gallons': 0.003785411784,
    'UK Gallons': 0.00454609,
  };

  String _fromUnit = 'Liters';
  String _toUnit = 'US Gallons';
  String _result = '—';
  String? _errorText;
  ...
  void _convert() {
    ...
    final double valueInCubicMeters = value * _cubicMetersPerUnit[_fromUnit]!;
    final double converted = valueInCubicMeters / _cubicMetersPerUnit[_toUnit]!;
      ...
      child: Padding(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: const Icon(Icons.invert_colors_off, color: _primaryColor),
