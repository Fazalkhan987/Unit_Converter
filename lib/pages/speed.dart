...
class _SpeedConverterPageState extends State<SpeedConverterPage> {
  ...
  final List<String> _speedUnits = const [
    'Meters per second',
    'Kilometers per hour',
    'Miles per hour',
    'Feet per second',
  ...
  static const Map<String, double> _metersPerSecondPerUnit = {
    'Meters per second': 1,
  ...
  String _fromUnit = 'Kilometers per hour';
  String _toUnit = 'Meters per second';
  String _result = '—';
  String? _errorText;
  ...
  void _convert() {
    ...
    final double valueInMetersPerSecond = value * _metersPerSecondPerUnit[_fromUnit]!;
    final double converted = valueInMetersPerSecond / _metersPerSecondPerUnit[_toUnit]!;
      ...
      child: Padding(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: const Icon(Icons.speed, color: _primaryColor),
