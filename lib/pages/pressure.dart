...
class _PressureConverterPageState extends State<PressureConverterPage> {
  ...
  final List<String> _pressureUnits = const [
    'Pascal',
    'Kilopascal',
    'Megapascal',
    'Bar',
  ...
  static const Map<String, double> _pascalsPerUnit = {
    'Pascal': 1,
    'Kilopascal': 1000,
    'Megapascal': 1000000,
    'Bar': 100000,
  ...
  void _convert() {
    ...
    final double valueInPascals = value * _pascalsPerUnit[_fromUnit]!;
    final double converted = valueInPascals / _pascalsPerUnit[_toUnit]!;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Pressure Calculator'),
      ...
      child: Padding(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: const Icon(Icons.air, color: _primaryColor),
