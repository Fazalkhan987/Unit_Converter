...
class _LengthConverterPageState extends State<LengthConverterPage> {
  ...
  final List<String> _lengthUnits = const [
    'Millimeters',
    'Centimeters',
    'Meters',
    'Kilometers',
  ...
  // How many meters make up ONE unit of each type.
  // These are exact standard conversion factors (no approximation needed,
  // unlike months/years in the time converter).
  static const Map<String, double> _metersPerUnit = {
    'Millimeters': 0.001,
    'Centimeters': 0.01,
    'Meters': 1,
    'Kilometers': 1000,
  ...
  void _convert() {
    ...
    final double valueInMeters = value * _metersPerUnit[_fromUnit]!;
    final double converted = valueInMeters / _metersPerUnit[_toUnit]!;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Length Calculator'),
